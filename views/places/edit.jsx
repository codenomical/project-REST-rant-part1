// Bonus: Created edit form. I think this is going to be used to edit the restaurant info.
...
function edit_Form (data) {
    return (
        <Def>
            <main>
                <h1> Edit Place </h1>
                <form method="POST" action={`/places/${data.place.id}?_method=PUT`} className="form-alignment">
                    <div className="row">
